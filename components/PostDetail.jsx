          ...
          <div className="flex items-center mb-8 w-full">
            <div className="hidden md:flex items-center justify-center lg:mb-0 lg:w-auto mr-8">
              <Image
                ...
                src='/_next/static/media/website.c2473331.jpg' 
              />
              <p className="inline align-middle text-gray-700 ml-2 font-medium text-lg">{post.author}</p>
            </div>
            <div classNamsrc='/_next/static/media/website.c2473331.jpg' e="font-medium text-gray-700">
